...
db.Portfolio.belongsTo(db.User, {foreignKey: 'user_id', sourceKey: 'id'});

// portfolio 1 : 1 info - 포트폴리오 하나 당 입력하는 회원 정보는 하나다
db.Portfolio.hasOne(db.Info, {foreignKey: 'port_id', sourceKey: 'id'});
db.Info.belongsTo(db.User, {foreignKey: 'port_id', sourceKey: 'id'});
...
db.Project_Experience.belongsTo(db.Info, {foreignKey: 'info_id', sourceKey: 'id'});

// portfolio 1 : 1 template - 포트폴리오는 하나의 템플릿으로 구성되므로 1:1
db.Info.hasOne(db.Template, {foreignKey: 'port_id', sourceKey: 'id'});
db.Template.belongsTo(db.Info, {foreignKey: 'port_id', sourceKey: 'id'});
...
db.Category_Header.belongsTo(db.Portfolio, {foreignKey: 'port_id', sourceKet: 'id'});
...
db.Dev_Field.belongsTo(db.Category_Header, {foreignKey: 'category_id', sourceKey: 'id'});
db.Category_Header.hasOne(db.Spe_Field, {foreignKey: 'category_id', sourceKey: 'id'});
db.Spe_Field.belongsTo(db.Category_Header, {foreignKey: 'category_id', sourceKey: 'id'});
